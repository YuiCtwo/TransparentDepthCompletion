...
if __name__ == '__main__':
    ...
    from dataset import TUMRGBDDataset, ICLNUIMDataset, ReconDataset, BlenderDataset, ReconDataset2
    ...
    # python ptam.py --dataset reco --path /home/ctwo/recon_data --depth_dir depth_refine2
    ...
    elif 'reco' in args.dataset.lower():
        dataset = ReconDataset(args.path, depth_dir=args.depth_dir)
    elif 'glass' in args.dataset.lower():
        dataset = BlenderDataset(args.path)
    elif 'reco2' in args.dataset.lower():
        dataset = ReconDataset2(args.path)
